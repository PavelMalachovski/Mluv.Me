...
import { BookOpen, Target, BookmarkCheck, MessageCircle } from "lucide-react"
...
type LearnTab = "grammar" | "challenges" | "words" | "slang"
...
function LearnContent() {
  ...
  const [activeTab, setActiveTab] = useState<LearnTab>(
    ["grammar", "words", "challenges", "slang"].includes(initialTab) ? initialTab : "words"
  )
